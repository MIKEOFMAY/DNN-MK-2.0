  ...
  function initWorkPage() {
    ...
    if (window.innerWidth > 768 && typeof Shery !== "undefined") {
      ...
      var hoverElements = document.querySelectorAll(
        "a, .work-card, .back-link, #menu, #nav-part2 h4, .interactive-circle, .interactive-circle2"
      );
      ...
      // Magnetic effect for navigation and interactive elements
      Shery.makeMagnet("#nav-part2 h4, .back-link, #menu, .interactive-circle, .interactive-circle2", {
        ease: "cubic-bezier(0.23, 1, 0.320, 1)",
        duration: 0.6
      });
    }
